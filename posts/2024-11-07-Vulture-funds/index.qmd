...
In this post, I would like to discuss the funds identified by researchers in finance and economics as a specific category of hedge funds called vulture funds. There are indeed investors whose actions are comparable to those of vultures on companies, or even on governments. The first wave of research on this subject focused almost exclusively on the impact of these funds on governments. One of the very first studies to document the impact of vulture funds on companies is Gietzmann, 2018. In my study published in Finance-Contrôle-Stratégie Journal (2024), I propose an in-depth exploration of the actions of vulture funds. In particular, I demonstrate the role of vulture funds in the failure of LBO companies due to their actions throughout the period of financial distress. Indeed, these periods of financial distress are perfect for vulture funds to purchase the debt of these companies, which they use as a leverage tool for a *loan-to-own* strategy or for a *yield chasing* strategy. They typically seek to maximize returns by employing a variety of aggressive strategies (both legal and extralegal), but these actions can exacerbate the financial difficulties of the distressed company.
...
The aggressive tactics employed by vulture funds can exacerbate corporate financial instability and, in the case of sovereign debt, destabilize national economies. My paper notes that this approach often results in increased costs (in particular cognitive costs) and reduced investment in long-term, value-generating activities... More generaly, vulture funds are not limited to companies in difficulty, but also extend to governments. The modus operandi remains the same, with a strategy aimed at buying debt and then demanding a higher return than expected.
